...
## Ejemplo aplicado: Modelo VAR con tres variables macroeconómicas
...
### 🔹 2. Especificación del modelo VAR(1)
...
### 🔹 5. Aumentando la complejidad: VAR(2)
...
Identificación económica que usaré (Debemos ajustar si quieremos):
...
## 📈 **3️⃣ Resultados en primeras diferencias**
...
## **4️⃣ Implicación para el modelo VAR**
...
## Interpretación del Test de Johansen

### 1️⃣ Prueba de la traza (Trace Test)
...
### 2️⃣ Prueba del máximo eigenvalor (Eigenvalue Test)
...
### 3️⃣ Interpretación de los eigenvectores (β)
...
### 4️⃣ Interpretación de los weights (α)
...
El hecho de que \$L\_{PP,t-1} = 1 \$ indica que **β está normalizado sobre ( L\_{PP} )**, aunque podrías normalizar sobre otra variable si deseas interpretar las **elasticidades** de manera más conveniente.

------------------------------------------------------------------------

### 🔹 ¿Cómo se usa el ECT en el VECM?
...
-   Cuando ( ECT\_{t-1} \> 0 ) (es decir, el precio está **por encima del equilibrio**),\
...
## 🔹 Diagnósticos del modelo VAR / VECM

------------------------------------------------------------------------

### 1️⃣. Portmanteau test → Autocorrelación serial
...
### 2️⃣. ARCH test → Heterocedasticidad condicional
...
### 3️⃣. Normalidad multivariada (Jarque–Bera test)
...
## 🔹 Función `irf()` — Respuestas Impulso–Respuesta (IRF)
...
El gráfico que produce `irf()` muestra cómo un **shock inesperado** en ( L\_{PP} ) (por ejemplo, precios o política pública) afecta al **PIB** (( L\_{PIB} )) a lo largo de 12 períodos.
...
> “Un aumento inesperado en ( L\_{PP} ) genera un **incremento transitorio** en ( L\_{PIB} ) durante los primeros **3 períodos**, que luego **se disipa** gradualmente.”
